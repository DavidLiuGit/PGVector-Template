...
def validate_metadata_filter(filter_obj: MetadataFilter, metadata_cls: Type[BaseDocumentMetadata]) -> None:
    ...
    for i, part in enumerate(field_path):
        ...
        if hasattr(field_type, 'model_fields'):
            ...
            raise ValueError(f"Cannot navigate into non-model field '{part}' in path '{filter_obj.field_name}'")
